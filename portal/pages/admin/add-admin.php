...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkEmailStmt = $conn->prepare("SELECT email FROM tbl_admin WHERE email = ?");
    ...
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="mb-2 mt-4">
                ...
                color: navy;">I have an Account <a href="../login/login.php" style="text-decoration: none;">Login</a></p>
            </div>
        </form>
    </div>
    <script>
